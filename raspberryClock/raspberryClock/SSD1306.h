...
constexpr auto VCC_STATE = SSD1306_CMDS::SSD1306_SWITCHCAPVCC;
constexpr auto PAGES = 8;

inline constexpr unsigned char uchar_cast(SSD1306_CMDS cmd) noexcept
{
...
public:
	...
	inline unsigned int Width() const noexcept { return width_; }
	inline unsigned int Height() const noexcept { return height_; }

	Bitmap& Flip();

	const unsigned char* GetData() const { return data_.data(); }
	unsigned int GetDataSize() const { return data_.size(); }

private:
	void PrepareData_();

	unsigned int width_, height_, rows_, columns_, bitmapSize_;

	std::vector<std::vector<unsigned char>> dataBitmap_;
...
public:
	...
	void SetBitmap(uint8_t x, uint8_t y, Bitmap bitmap);
	void Write(uint8_t x, uint8_t y, const std::string& str, const IFont& font);

	void SendCmd(SSD1306_CMDS cmd);
...
public:
	...
	virtual void WriteOnScreen(uint8_t x, uint8_t y, const std::string& str, SSD1306& screen) const = 0;
};

class IInvertableFont
{
public:
	virtual ~IInvertableFont() { }

	inline bool GetInvertMode() const noexcept { return mode_; }
	inline void SetInvertMode(bool mode) noexcept { mode_ = mode; }

protected:
	bool mode_ = false;
};

class Font12x6 : public IFont, public IInvertableFont
{
public:
	enum
	{
...
class Font16x8 : public IFont, public IInvertableFont
{
public:
	enum
	{
...
static const unsigned char waveshare[1024] = //128x64
{
...
static const unsigned char Sun4016[96] = //SUN
{
...
static const unsigned char Square88[8] = //square
{
...
namespace images
{
	static Bitmap Waveshare()	{ return Bitmap(128, 64, graphics::waveshare); }
	static Bitmap Sun()		{ return Bitmap(40, 16, graphics::Sun4016); }
	static Bitmap Signal()	{ return Bitmap(8, 16, graphics::Singal816); }
	static Bitmap Message()	{ return Bitmap(8, 16, graphics::Msg816); }
	static Bitmap Battery()	{ return Bitmap(8, 16, graphics::Bat816); }
	static Bitmap Bluetooth()	{ return Bitmap(8, 8, graphics::Bluetooth88); }
	static Bitmap GPRS()		{ return Bitmap(8, 8, graphics::GPRS88); }
	static Bitmap Alarm()		{ return Bitmap(8, 8, graphics::Alarm88); }
	static Bitmap Square()	{ return Bitmap(8, 8, graphics::Square88); }
}

namespace fonts
{

void filterSmallFonts(std::string& str);
void filterBigFonts(std::string& str);

void SSD1306_char(unsigned char x, unsigned char y, char acsii, char size, char mode, SSD1306& screen);
...
void SSD1306_char1616(uint8_t x, uint8_t y, unsigned char chChar, SSD1306& screen);
void SSD1306_char3216(uint8_t x, uint8_t y, unsigned char chChar, SSD1306& screen);
...
static const uint8_t Font1616[11][32] =
{
